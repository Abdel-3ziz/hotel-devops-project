...
namespace Hotel.Model
{
    public class dbclass
    {
        ...
        public dbclass()
{
    var SQLcon = Environment.GetEnvironmentVariable("CONNECTION_STRING");
    con = new SqlConnection(SQLcon);
}

/*docker run --rm -p 8081:80 \
  -e CONNECTION_STRING="Server=host.docker.internal,1433;Database=Hotel;User Id=hotel_user;Password=250025;TrustServerCertificate=True;Encrypt=False;" \
  hotel-app */  
